 const num = 3 //số lần spam bị ban -1, ví dụ 5 lần gì lần 6 sẽ bị ban
...
module.exports.handleEvent = async function ({ Users, Threads, api, event})  {
  ...
  if ((global.client.autoban[senderID].timeStart + (timee*1000)) <= Date.now()) {
    ...
    if (global.client.autoban[senderID].number >= num) {
      ...
      api.sendMessage("⚡️Bạn đã bị cấm sử dụng bot ib admin xin gỡ, tùy trường hợp sẽ được gỡ https://www.facebook.com/ngduytuanhmm\n⚡️ID: " + senderID + " \n⚡️Tên: " + dataUser.name + `\n⚡Lý do: spam bot ${num} lần/${timee}s\n\n✔️Đã báo cáo đến admin bot`, threadID,
    () => {
